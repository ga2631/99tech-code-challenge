# Problem 1: Interactive Currency Swap Application (Fancy Form)
...
```bash
# Start Problem 1 via root docker-compose
docker compose up problem1 -d
```

Or from inside `src/problem1`:
```bash
cd src/problem1
